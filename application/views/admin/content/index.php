...
<div class="page-header-breadcrumb">
    <div class="page-heading hidden-xs"><h1 class="page-title">Buttons</h1></div>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Default</div>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Color</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Square</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Square Color</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
    ...
    <div class="portlet-body">
        ...
        <button type="button" class="btn btn-dark btn-square">Darks</button>
    </div>
</div>
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Group</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
            ...
            <div class="btn-group">
                ...
                <div class="btn-group">
                    <button type="button" data-toggle="dropdown"
                            class="btn btn-default dropdown-toggle">Dropdown
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Sizing</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
...
<div class="portlet">
<div class="portlet-header">
    <div class="caption">Single button dropdowns</div>
    <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                          data-target="#modal-config"
                                                          class="fa fa-cog"></i><i
            class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
...
<div class="portlet-body">
    <div class="btn-group">
        <button type="button" data-toggle="dropdown"
                class="btn btn-default dropdown-toggle">Default
            &nbsp;<span class="caret"></span></button>
    ...
    <div class="btn-group">
        <button type="button" data-toggle="dropdown"
                class="btn btn-primary dropdown-toggle">Primary
            &nbsp;<span class="caret"></span></button>
        <ul role="menu" class="dropdown-menu">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
    ...
    <div class="btn-group">
        <button type="button" data-toggle="dropdown"
                class="btn btn-success dropdown-toggle">Success
            &nbsp;<span class="caret"></span></button>
        <ul role="menu" class="dropdown-menu">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
    ...
    <div class="btn-group">
        <button type="button" data-toggle="dropdown"
                class="btn btn-warning dropdown-toggle">Warning
            &nbsp;<span class="caret"></span></button>
        <ul role="menu" class="dropdown-menu">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
    ...
    <div class="mbl"></div>
    <div class="btn-group">
        <button type="button" data-toggle="dropdown" class="btn btn-red dropdown-toggle">Red
            &nbsp;<span class="caret"></span></button>
        <ul role="menu" class="dropdown-menu">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Icon</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
    </div>
    <div class="portlet-body"><a href="#" class="btn btn-default">Default
            &nbsp;<i class="fa fa-edit"></i></a>&nbsp;<a href="#" class="btn btn-primary">Primary
            &nbsp;<i class="fa fa-tint"></i></a>&nbsp;<a href="#" class="btn btn-success">Success
            &nbsp;<i class="fa fa-rocket"></i></a>&nbsp;<a href="#" class="btn btn-info"><i
                class="fa fa-user"></i>&nbsp;
            Info</a>&nbsp;<a href="#" class="btn btn-warning"><i class="fa fa-star-o"></i>&nbsp;
            Warning</a>&nbsp;<a href="#" class="btn btn-danger">Danger
            &nbsp;<i class="fa fa-search"></i></a>

        <div class="mbl"></div>
        <a href="#" class="btn btn-red"><i class="fa fa-edit"></i></a>&nbsp;<a href="#"
                                                                               class="btn btn-orange"><i
                class="fa fa-tint"></i></a>&nbsp;<a href="#" class="btn btn-yellow"><i
                class="fa fa-rocket"></i></a>&nbsp;<a href="#" class="btn btn-green"><i
                class="fa fa-user"></i></a>&nbsp;<a href="#" class="btn btn-blue"><i
                class="fa fa-star-o"></i></a>&nbsp;<a href="#" class="btn btn-pink"><i
                class="fa fa-search"></i></a>&nbsp;<a href="#" class="btn btn-violet"><i
                class="fa fa-keyboard-o"></i></a>&nbsp;<a href="#" class="btn btn-grey"><i
                class="fa fa-headphones"></i></a>&nbsp;<a href="#" class="btn btn-dark"><i
                class="fa fa-font"></i></a></div>
</div>
</div>
<div class="col-lg-6">
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Outlined</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Outlined Color</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Outlined Square</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Button Outlined Square Color</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
    ...
    <div class="portlet-body">
        ...
        <button type="button" class="btn btn-dark btn-outlined btn-square">Darks</button>
    </div>
</div>
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Vertical variation</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
    ...
    <div class="portlet-body">
        ...
        <div class="btn-group-vertical mbm">
            ...
            <div class="btn-group">
                <button type="button" data-toggle="dropdown"
                        class="btn btn-primary dropdown-toggle">Dropdown
                    &nbsp;<i class="fa fa-angle-down"></i></button>
                <ul role="menu" class="dropdown-menu">
                    <li><a href="#">Dropdown link</a></li>
                    <li><a href="#">Dropdown link</a></li>
        ...
        <div class="btn-group-vertical mbm">
            ...
            <div class="btn-group">
                <button type="button" data-toggle="dropdown"
                        class="btn btn-yellow dropdown-toggle">Dropdown
                    &nbsp;<i class="fa fa-angle-down"></i></button>
                <ul role="menu" class="dropdown-menu">
                    <li><a href="#">Dropdown link</a></li>
                    <li><a href="#">Dropdown link</a></li>
        ...
        <div class="btn-group-vertical mbm">
            ...
            <div class="btn-group">
                <button type="button" data-toggle="dropdown"
                        class="btn btn-blue dropdown-toggle">Dropdown
                    &nbsp;<i class="fa fa-angle-down"></i></button>
                <ul role="menu" class="dropdown-menu">
                    <li><a href="#">Dropdown link</a></li>
                    <li><a href="#">Dropdown link</a></li>
...
<div class="portlet">
    <div class="portlet-header">
        <div class="caption">Justified Button Groups</div>
        <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                              data-target="#modal-config"
                                                              class="fa fa-cog"></i><i
                class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
    ...
    <div class="portlet-body">
        <div class="btn-group btn-group-justified"><a role="button"
                                                      class="btn btn-default">Left</a><a
                role="button" class="btn btn-default">Middle</a><a role="button"
        ...
        <div class="btn-group btn-group-justified"><a role="button"
                                                      class="btn btn-default">Left</a><a
                role="button" class="btn btn-default">Middle</a>

            <div class="btn-group"><a data-toggle="dropdown"
                                      class="btn btn-default dropdown-toggle">Dropdown
                    &nbsp;<span class="caret"></span></a>
                <ul role="menu" class="dropdown-menu">
                    <li><a href="#">Action</a></li>
...
<div class="portlet">
<div class="portlet-header">
    <div class="caption">Split button dropdowns</div>
    <div class="tools"><i class="fa fa-chevron-up"></i><i data-toggle="modal"
                                                          data-target="#modal-config"
                                                          class="fa fa-cog"></i><i
            class="fa fa-refresh"></i><i class="fa fa-times"></i></div>
...
<div class="portlet-body">
    <div class="btn-group">
        <button type="button" class="btn btn-default">Default</button>
        <button type="button" data-toggle="dropdown"
                class="btn btn-default dropdown-toggle"><span class="caret"></span><span
    ...
    <div class="btn-group">
        <button type="button" class="btn btn-success">Success</button>
        <button type="button" data-toggle="dropdown"
                class="btn btn-success dropdown-toggle"><span class="caret"></span><span
                class="sr-only">Toggle Dropdown</span></button>
        <ul role="menu" class="dropdown-menu">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
    ...
    <div class="btn-group">
        <button type="button" class="btn btn-warning">Warning</button>
        <button type="button" data-toggle="dropdown"
                class="btn btn-warning dropdown-toggle"><span class="caret"></span><span
                class="sr-only">Toggle Dropdown</span></button>
        <ul role="menu" class="dropdown-menu">
            <li><a href="#">Action</a></li>
            <li><a href="#">Another action</a></li>
